...
const mockTalent: TalentProfile[] = [
  ...
  },
  {
    ...
    overallScore: 83,
    scoreChange: 6,
    strengths: ["Outbound", "SDR", "Cold Email"],
    specialties: ["SaaS", "MarTech"],
    experience: "2 years",
    location: "Denver, CO",
    availability: "available",
    ...
    avgCallScore: 80,
    topSkills: [
      { name: "Cold Calling", score: 92 },
      { name: "Persistence", score: 88 },
      { name: "Scripting", score: 85 }
    ],
    verified: true
  },
];
...
const PublicTalentPage = () => {
  ...
  const [selectedAction, setSelectedAction] = useState<"contact" | "view" | null>(null);
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <Badge variant="secondary" className="ml-2">Talent Pool</Badge>
            </div>
            <div className="flex items-center gap-3">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 space-y-8">
        ...
        <div className="text-center mb-12">
          <Badge variant="secondary" className="mb-4">
            ...
            {mockTalent.filter(t => t.availability === "available").length} sales reps available now
          </Badge>
          <h1 className="text-3xl md:text-4xl font-display font-bold mb-4">
            Find Top Sales Talent
          </h1>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Discover pre-verified sales professionals with real performance scores. 
            All candidates are ranked by actual call performance, not just resumes.
          </p>
        </div>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">{mockTalent.filter(t => t.verified).length}</p>
        ...
        <Card className="bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-lg mx-auto">
              Create your free Caliber profile, practice with AI roleplays, and showcase your real sales performance to recruiters.
            </p>
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedAction === "contact" 
                ? "Create a free account to contact sales professionals and access their full profiles."
                : "Create a free account to view detailed profiles, call recordings, and performance data."}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 pt-4">
            <Button className="w-full gap-2" onClick={() => navigate("/auth?signup=true")}>
              Create Free Account
              <ArrowRight className="w-4 h-4" />
            </Button>
